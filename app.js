// Menüdeki her öğeyi içeren yapı //
const menu = [
  {
    id: 1,
    title: "Tteokbokki",
...
// Menü elemanlarını filtreleme
function filterMenu() {
  const category = this.id;
  const menuItems = category === "All" ? menu : menu.filter(item => item.category === category);
  renderMenuItems(menuItems);
}

// Menü elemanlarını ekrana yazdırma
